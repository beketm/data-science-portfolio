...
- ### Machine Learning
	...
	- [Simple Neural Network Implementation from Scratch](https://github.com/beketm/data-science-portfolio/blob/master/SingleLayerNN.ipynb): Implementation of a single layer neural network with various number of nodes. Train and test data were autogenerated using scikit-learn library. 
	
	- [Supervised Learning: Heart Failure Prediction](https://github.com/beketm/data-science-portfolio/blob/master/Heart%20Failure%20Prediction/Heart-Failure.ipynb): Applying several supervised machine learning algorithms to unbalanced dataset and selecting a few of them to predict whether a patience will have heart failure.
...
If you liked what you saw, want to have a chat with me about the portfolio, work opportunities, or collaboration, send me an email at beket.myrzanov@nu.edu.kz. 
